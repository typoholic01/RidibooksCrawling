...
public class KeywordFantasy {
	private static final Logger logger = LoggerFactory.getLogger(KeywordFantasy.class);
	
	public List<Ridibook> getRidibookFantasyList(int page) throws IOException {
		logger.info("진입");
		//init
		String url = "https://ridibooks.com/keyword-finder/fantasy?sub_genre=fantasy&group_id=18?page="+page;
		String category = "판타지";
